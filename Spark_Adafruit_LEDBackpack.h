...
class Adafruit_AlphaNum4 : public Adafruit_LEDBackpack {
 public:
  ...
  int ledPrint(String _message, int _displaySize, int _mode, int _method, int _methodParameter, bool _rollin, bool _rollout);
...
class Adafruit_BicolorMatrix : public Adafruit_LEDBackpack, public Adafruit_GFX {
 public:
  Adafruit_BicolorMatrix(void);
    ...
    void matrix_scroll_print(Adafruit_BicolorMatrix _matrix[], String &_display_message, int &_current_display_colour, int _default_display_colour, bool _single_char, int &_display_position, int _display_size, int _delay);
    void matrix_print(Adafruit_BicolorMatrix _matrix[], int _size, String _text, int _colour, int _x);
    int matrix_screen_chars(int _size, String &_padding);
    void prepare_matrix(Adafruit_BicolorMatrix _matrix[], int _display_size, bool _wrap, int _size, int _rotation, int _colour, int _brightness);
    void drawPixel(int16_t x, int16_t y, uint16_t color);
